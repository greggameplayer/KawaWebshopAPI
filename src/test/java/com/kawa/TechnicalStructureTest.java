...
@AnalyzeClasses(packagesOf = KawaWebshopApiApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(KawaWebshopApiApp.class), alwaysTrue())
